...
def generate_certificate_image(sertifikat_obj):
    ...
    try:
        fonts = {
            ...
            "penandatangan": ImageFont.truetype(get_font_path("kompetensi"), FONT_SIZES["penandatangan"]),
    ...
    penandatangan = sertifikat_obj.penandatangan
    ...
    draw_centered_text(draw, penandatangan, fonts["penandatangan"], COLORS["penandatangan"], POSITIONS["penandatangan_y"], img.width)
